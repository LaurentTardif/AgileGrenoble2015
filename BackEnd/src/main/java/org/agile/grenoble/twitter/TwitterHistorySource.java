...
import org.agile.grenoble.twitter.twitter.SearchEndPoint;
import org.agile.grenoble.twitter.twitter.TwitterStaticSource;
 ...
 */
public class TwitterHistorySource extends TwitterStaticSource {
    ...
    public TwitterHistorySource(String authPath) {
        super(authPath);
    }
    ...
    protected void initializeConnection() {
        ...
        if (LOG.isInfoEnabled()) {
            LOG.info("Initializing TwitterHistorySource connection");
        }
        ...
        if (LOG.isInfoEnabled()) {
            LOG.info("TwitterHistorySource established successfully");
        }
    }
     ...
     */
    private void configEndpoint(SearchEndPoint endpoint) {
        //TODO
