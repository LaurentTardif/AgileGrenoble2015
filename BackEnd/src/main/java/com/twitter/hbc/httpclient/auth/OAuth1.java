...
public class OAuth1 implements Authentication {
    ...
    private final static Logger logger = LoggerFactory.getLogger(OAuth1.class);
    ...
    public void signRequest(HttpUriRequest request, String postParams) {
        ...
        //logger.info("Sign Request " + request ) ;
        //logger.info("Sign Request (uri)" + request.getURI() ) ;
        //logger.info("Sign Request (query)" + request.getURI().getRawQuery() ) ;
        ...
        //logger.info("IT WAS SIGNED WITH token:" +token) ;
        //logger.info("IT WAS SIGNED WITH ts:" +tokenSecret) ;
        //logger.info("IT WAS SIGNED WITH c:" + consumerKey ) ;
        //logger.info("IT WAS SIGNED WITH cs:" +consumerSecret) ;
        //logger.info("IT WAS SIGNED WITH header:" +header) ;
